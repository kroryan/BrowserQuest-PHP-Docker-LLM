define(['infomanager', 'bubble', 'renderer', 'map', 'animation', 'sprite', 'tile',
        ...
        'item', 'mob', 'npc', 'player', 'character', 'chest', 'mobs', 'exceptions', 'config', 'i18n', '../../shared/js/gametypes'],
function(InfoManager, BubbleManager, Renderer, Map, Animation, Sprite, AnimatedTile,
         Warrior, GameClient, AudioManager, Updater, Transition, Pathfinder,
         Item, Mob, Npc, Player, Character, Chest, Mobs, Exceptions, config, i18n) {
    ...
    var Game = Class.extend({
        ...
        connect: function(started_callback) {
            ...
            this.client.onWelcome(function(id, name, x, y, hp) {
                ...
                if(!self.storage.hasAlreadyPlayed()) {
                    ...
                    self.showNotification(i18n.get("game.welcome"));
                } else {
                    self.showNotification(i18n.get("game.welcome_back", [self.player.name]));
                ...
                self.client.onPlayerKillMob(function(kind) {
                    ...
                    if(mobName === 'boss') {
                        self.showNotification(i18n.get("game.combat.boss_killed"));
                    } else {
                        if(_.include(['a', 'e', 'i', 'o', 'u'], mobName[0])) {
                            self.showNotification(i18n.get("game.combat.killed_vowel", [mobName]));
                        } else {
                            self.showNotification(i18n.get("game.combat.killed_consonant", [mobName]));
                        }
                    }
        ...
        showNotification: function(message) {
            if(this.notification_callback) {
                ...
                if(message.startsWith('game.') || message.startsWith('ui.') || message.startsWith('items.') || message.startsWith('entities.')) {
