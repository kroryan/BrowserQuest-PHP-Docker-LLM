define(['jquery', 'app'], function($, App) {
    ...
    var initGame = function() {
        require(['game', 'i18n'], function(Game, i18n) {
            
            // Inicializar el sistema de traducción antes de crear el juego
            i18n.init(function() {
                log.info("Translation system initialized. Current language: " + i18n.currentLang);
                
                // Traducir la interfaz de usuario después de inicializar el sistema de traducción
                app.translateUI();
